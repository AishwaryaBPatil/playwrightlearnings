...
Two ways a module shares code: named export (non-default) and default export. This chapter shows both. Files involved:

File	Exports	Kind
utils.js	BASE_URL, formatTestName	named
testutils.js	BASE_URL, formatUpperCaseString	named
logger.js	log (default) + log2 (named)	both
169_Utils.js	— imports named	consumer
170_Logger.js	— imports default	consumer
